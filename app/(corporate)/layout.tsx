  ...
  return (
    ...
    {/* <html className="scroll-pt-20 lg:scroll-pt-60 overflow-x-hidden" lang="en" data-theme="wireframe">
       <body className={`text-base-content ${raleway.className} p-0`}>  */}
        ...
        <header className="sticky top-0 z-50 h-40 bg-base-100 opacity-90" >
          <NavBar />
        </header>
        {children}
        <footer className="p-10 bg-base-200 text-base-content">
          ...
          <div className="grid grid-cols-3 grid-rows-1">
            ...
            <Link className="text-center" href="/disclaimer">Disclaimer</Link>
            <Link className="text-center" href="/terms-and-conditions">Terms &amp; Conditions</Link>
          </div>
          <div className="mt-10 mx-auto grid grid-flow-col gap-4 w-30">
            {/* LinkedIn */}
