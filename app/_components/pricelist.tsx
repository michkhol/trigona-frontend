...
import { useRef, useEffect, ChangeEvent, RefObject } from "react";
...
export default function PriceList({prices, openDialogRef}: { prices: SrvStripe.Price[], openDialogRef: RefObject<ModalCheckout | undefined>}) {
          ...
          <div className="flex mx-4 px-4 border border-red-800" >
            <div className="">
              <h2 className="text-2xl mt-4 text-red-800">GROUP TRAINING SERIES</h2>
                ...
                <div className="mt-4">
                  <form className="text-center" action={(data) => openDialogRef.current!(data)}>
