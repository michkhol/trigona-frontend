...
export default function Contact() {
  return (
    <div className="flex flex-col justify-center w-full mx-2 mb-6">
      <div><h2 className="my-10 text-center text-8xl">We are Here to <span className="text-red-800 italic font-semibold">Help</span></h2></div>
      <div className="m-auto" >
        ...
        <form name="contact" method="POST" data-netlify="true" action="/thanks.html">
          ...
          <input type="text" placeholder="Required" required={true} className="input input-bordered w-full max-w-xs border-red-800" name="name"/>
          </label>
          <label className="form-control w-full max-w-xs">
            <div className="label">
              <span className="label-text">Your email:</span>
            </div>
            <input type="email" placeholder="Required" required={true} className="input input-bordered w-full max-w-xs border-red-800" name="email" />
          </label>
        <label className="form-control">
          <div className="label">
            <span className="label-text">Message:</span>
          </div>
          <textarea className="textarea textarea-bordered h-24 border-red-800" placeholder="Required" required={true} name="message" ></textarea>
        </label>
